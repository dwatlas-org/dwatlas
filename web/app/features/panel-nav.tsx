  ...
  return (
    ...
    >
      <SidebarHeader className="p-4 pb-2">
        <div className="flex items-center justify-between gap-2">
          <div className="text-xl font-bold tracking-tight text-slate-900 select-none">
            DeliveryWorker<span className="text-[#f97316]">Atlas</span>
          </div>
          <button
            type="button"
            onClick={toggleSidebar}
      ...
      <SidebarContent className="no-scrollbar px-3 py-1">
        ...
        <div className="mt-4 mb-1 px-3 text-xs font-bold tracking-wider text-slate-400 uppercase">
          DATA PANEL
        </div>
          ...
          {panelItems.map((item) => (
            ...
            >
              ...
              >
                ...
                <ChevronDown className="ml-auto size-4 text-slate-800 transition-transform duration-200 group-data-open/collapsible:rotate-180" />
              </CollapsibleTrigger>
              <CollapsibleContent>
                <div className="flex flex-col py-1 pl-7 pr-2">
                  {item.items.map((subItem) => (
                    <a
                      key={subItem.title}
                      href={subItem.url}
                      className="flex items-center gap-2 py-1.5 text-sm font-medium text-slate-800 transition-colors hover:text-blue-600"
                    >
      ...
      <SidebarFooter className="bg-[#050b1a] p-4 text-white">
        <a
          href="#profile"
          className="flex items-center justify-between rounded-md p-1 transition-colors hover:bg-white/5"
        >
